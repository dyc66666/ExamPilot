...
Page({
  ...
  loadErrors() {
    const wrongQuestions = (wx.getStorageSync('wrongQuestions') || []).map(item => ({ ...item, confidenceText: confidenceText(item.confidenceWhenWrong), dateText: formatDate(item.wrongTime) }))
